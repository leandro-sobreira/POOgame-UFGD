from classes.standard import StandardDeck, StardardPlayer

class BlackjackGame:
    def __init__(self, player_data):
        self.player = StardardPlayer(player_data['name'], player_data['blackjack_points'])
        self.table = StardardPlayer("Dealer") # The dealer can be represented as a player
